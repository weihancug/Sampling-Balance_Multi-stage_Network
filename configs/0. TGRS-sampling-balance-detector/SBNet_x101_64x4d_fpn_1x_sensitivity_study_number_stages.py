...
model = dict(
    ...
    bbox_head=[
        ...
        dict(
            ...
            num_classes=81,
            target_means=[0., 0., 0., 0.],
            target_stds=[0.022, 0.022, 0.044, 0.044],
            reg_class_agnostic=True,
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
            loss_bbox=dict(type='BalancedL1Loss', alpha=0.5, gamma=1.5, beta=1.0,loss_weight=1.0)
        ...
        dict(
            ...
            num_classes=81,
            target_means=[0., 0., 0., 0.],
            target_stds=[0.015, 0.015, 0.029, 0.029],
            reg_class_agnostic=True,
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
            loss_bbox=dict(type='BalancedL1Loss', alpha=0.5, gamma=1.5, beta=1.0,loss_weight=1.0)
...
train_cfg = dict(
    ...
    stage_loss_weights=[1, 0.5, 0.25,0.15, 0.08]
)
test_cfg = dict(
    rpn=dict(
        nms_across_levels=False,
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_sensitivity_study_number_stages/'
load_from = None
resume_from = None
workflow = [('train', 1)]
