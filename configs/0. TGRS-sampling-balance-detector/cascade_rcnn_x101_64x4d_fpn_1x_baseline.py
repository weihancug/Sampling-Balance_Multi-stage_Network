# model settings 没有加上任何功能，作为弱小目标检测baseline
model = dict(
    type='CascadeRCNN',
    num_stages=3,
...
train_pipeline = [
    ...
    dict(
        type='Resize',
        #img_scale=[(1100, 1100),(1100, 1000), (1000, 800),(800, 600),(600,400)],
        img_scale=(1000, 1000),
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_baseline/'
load_from = None
resume_from = None
#resume_from ='./work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_CUGUAV10/latest.pth'
workflow = [('train', 1)]
